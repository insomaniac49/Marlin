 ...
 */
//#define HOTEND_IDLE_TIMEOUT     //Not worth the hassle
 ...
 */
#define USE_CONTROLLER_FAN      //Didn't use on 4.2.2
...
// LCD Print Progress options
  ...
  //#define SDCARD_READONLY                   // Read-only SD card (to save over 2K of flash)     //Disable for insanity check on power loss recovery
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement).    //enabled
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  20       // (steps or mm) Steps or millimeter distance for each Z babystep    //1 to 20
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping    //Enable
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor    //Enable
  #endif
#endif
 ...
 */
#define LIN_ADVANCE   //Already enabled
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.0    // Unit: mm compression per 1mm/s extruder speed   //Leave at 0 to set in Cura
 ...
 */
#define EMERGENCY_PARSER    //Enabled by default e3 v2
 ...
 */
#define ADVANCED_PAUSE_FEATURE    //Already enabled
  ...
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change   //disabled waste of time
 ...
 */
  ...
  //#define STEALTHCHOP_E   //Disabled, not sure why may be related to Linear Advance
 ...
 */
#define HOST_ACTION_COMMANDS        //Enable
#if ENABLED(HOST_ACTION_COMMANDS)
  //#define HOST_PAUSE_M76                // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback     //Enabled
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications   //Enabled
  #endif
